...
//
//WebUI.delay(5)
WebUI.sendKeys(findTestObject('Add SP with valid data/Page_/AddSP_input_NPWP_taxId'), Keys.chord(Keys.CONTROL, 'a'))
...
WebUI.sendKeys(findTestObject('Add SP with valid data/Page_/AddSP_input_NPWP_taxId'), Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('Add SP with valid data/Page_/AddSP_input_NPWP_taxId'), npwp)
