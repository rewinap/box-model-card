...
WebUI.click(findTestObject('Add SP with valid data/Page_/choose province'))
...
//
//WebUI.delay(5)
WebUI.click(findTestObject('Add SP with valid data/Page_/EditProvince'), FailureHandling.CONTINUE_ON_FAILURE)
