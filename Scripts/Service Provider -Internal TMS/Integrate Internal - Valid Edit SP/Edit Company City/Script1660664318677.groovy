...
WebUI.click(findTestObject('Add SP with valid data/Page_/choose city'))
...
//
//WebUI.delay(5)
WebUI.click(findTestObject('Add SP with valid data/Page_/EditCity'), FailureHandling.CONTINUE_ON_FAILURE)
