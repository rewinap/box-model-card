...
//
//WebUI.delay(5)
WebUI.sendKeys(findTestObject('Add SP with valid data/Page_/Add SP_input_SIUP_businessLicense'), Keys.chord(Keys.CONTROL, 
        'a'))
...
WebUI.sendKeys(findTestObject('Add SP with valid data/Page_/Add SP_input_SIUP_businessLicense'), Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('Add SP with valid data/Page_/Add SP_input_SIUP_businessLicense'), siub)
