...
//
//WebUI.delay(5)
WebUI.setText(findTestObject('Edit SP/Current Password'), CurrentPassword)
...
WebUI.setText(findTestObject('Edit SP/New Password'), NewPassword)

WebUI.setText(findTestObject('Edit SP/Conf New Password'), ConfNewPassword)
