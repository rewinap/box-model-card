...
//
//WebUI.delay(5)
WebUI.sendKeys(findTestObject('Add SP with valid data/Page_/addSP_input Email'), Keys.chord(Keys.CONTROL, 'a'))
...
WebUI.sendKeys(findTestObject('Add SP with valid data/Page_/addSP_input Email'), Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('Add SP with valid data/Page_/addSP_input Email'), invEmail)
...
//valueEmail = WebUI.getText(findTestObject('Add SP with valid data/Page_/addSP_input Email'))
